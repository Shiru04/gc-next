...
export function ContactForm() {
  ...
  if (status === "sent") return <div role="status" className="py-8 text-center"><h2 className="text-2xl font-extrabold text-brand-red">Request received</h2><p className="mt-2 text-black/70">Thank you. GC Heating & Cooling can now review your request.</p></div>;
