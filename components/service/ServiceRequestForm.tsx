...
export function ServiceRequestForm({ initialService = "ac_repair" }: { initialService?: string }) {
  const [service, setService] = useState(initialService === "maintenance" ? "maintenance" : "ac_repair");
