  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Las matemáticas favorecen la prevención. Para un sistema residencial estándar, la oferta actual es: precio regular $174 — ahorre $25 — ahora $149 con el cupón GC149. Las reparaciones que previene con mayor frecuencia pueden ascender a cientos o miles. Si a eso le sumamos la pérdida de eficiencia de un sistema descuidado, saltarnos el mantenimiento suele ser la opción más costosa.",
    ...
    related: [
      ...
      { href: "/es/promociones/mantenimiento", label: "Ahorre $25 — Afinación ahora $149" },
      { href: "/residencial/reparacion-de-aire-acondicionado-residencial", label: "Reparación de aire acondicionado" },
      {
