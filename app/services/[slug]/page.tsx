...
import { LEGACY_SERVICE_REDIRECTS } from "@/lib/services";
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-xl px-6 py-20 text-center">
        <h1 className="text-2xl font-extrabold">This page has moved</h1>
        <p className="mt-3 text-black/70">
          You’re being redirected. If nothing happens,{" "}
          <Link
