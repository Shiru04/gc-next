...
export default async function Page({ searchParams }: { searchParams: Promise<{ service?: string }> }) { const { service } = await searchParams; return <ScheduleService locale="es" initialService={service} />; }
