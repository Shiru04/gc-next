...
import { SERVICE_AREAS } from "@/lib/areas.es";
      ...
      >
        <div className="space-y-5">
          ...
          <p className="text-lg text-black/70 max-w-prose">
            Estamos orgullosos de servir a propietarios de viviendas en Los Ángeles y el condado de Orange con
            Instalación, reparación y mantenimiento confiables de HVAC.
          </p>
        ...
        <Card className="relative overflow-hidden">
          <div className="relative aspect-[4/3] w-full">
            <Image
              ...
              alt="Mapa de áreas de servicio de Calefacción y Refrigeración de GC"
              fill
          ...
          <div className="absolute inset-x-0 bottom-0 p-5">
            <div className="rounded-2xl bg-white/80 backdrop-blur border border-black/10 p-4">
              <p className="font-semibold">Sirviendo a Los Ángeles y OC</p>
              <p className="text-sm text-black/70">
                ¿No estás seguro de si estás dentro del alcance? Contáctenos y lo haremos
                confirmar.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-black/70">
              Explore nuestras áreas de servicio y descubra los servicios de HVAC cerca de usted.
            </p>
          </div>
          ...
          {filtered.map((area) => (
            <Card key={area.slug} className="p-5 flex flex-col gap-3">
              <div className="space-y-1">
                ...
                <p className="text-sm text-black/70">
                  Instalación, reparación y mantenimiento de HVAC
                </p>
              </div>

              <div className="flex gap-3 mt-auto">
                <Link
                  href={`/es/areas-de-servicio/${area.slug}`}
